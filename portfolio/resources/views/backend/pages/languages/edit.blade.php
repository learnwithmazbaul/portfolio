...
@section('title', 'Resume/Languages Edit')
            ...
            <div class="card-body">
                ...
                <form action="{{ route('languages.update', $language->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter your language name" value="{{ $language->name }}">
