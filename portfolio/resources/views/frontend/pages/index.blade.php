                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase">{{ $heroProperty->keyLine }}</div>
                        </div>
                        <div class="fs-3 fw-light text-muted">{{ $heroProperty->short_title }}</div>
                        <h1 class="display-3 fw-bolder mb-5"><span
                                class="text-gradient d-inline">{{ $heroProperty->title }}</span></h1>
                ...
                <div class="col-xxl-7">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img" src="{{ asset($heroProperty->img) }}" alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="text-muted">{{ $about->details }}</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            @foreach ($socialLinks as $sociallink)
                                <a class="text-gradient" href="{{ $sociallink->social_link }}" target="_blank">
                                    <i class="bi {{ $sociallink->icon_name }}"></i>
                                </a>
                            @endforeach
                        </div>
                    </div>
